    ...
    <div className="max-w-2xl mx-auto p-6 space-y-8">
      ...
      <section className="bg-white p-8 rounded-[32px] shadow-sm border border-slate-100 space-y-6">
        ...
        <div className="space-y-3 p-4 bg-slate-50 rounded-2xl">
          ...
          <select 
            value={notiMode} 
            onChange={(e) => setNotiMode(e.target.value)}
      ...
      <section className="bg-white p-8 rounded-[32px] shadow-sm border border-slate-100 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <select 
            ...
            className="w-full p-4 bg-slate-50 border border-slate-100 rounded-2xl outline-none focus:ring-2 focus:ring-emerald-500 font-medium"
          >
      ...
      <button 
        ...
        className="w-full py-5 bg-slate-900 text-white rounded-2xl font-black text-xl flex items-center justify-center gap-3 hover:bg-indigo-600 transition-all shadow-xl shadow-slate-200"
      >
